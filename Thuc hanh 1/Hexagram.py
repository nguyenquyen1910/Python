...
def check1(a, A, B, C, s):
    return (
        a[C[0]] + a[A[0]] + a[B[0]] + a[C[1]] == s
        and a[C[0]] + a[A[1]] + a[C[2]] + a[C[4]] == s
        and a[C[1]] + a[B[1]] + a[C[3]] + a[C[4]] == s
        and a[A[2]] + a[C[2]] + a[C[3]] + a[B[2]] == s
    )


def check2(a, A, B, C, s):
    return (
        a[A[0]] + a[B[1]] + a[C[1]] + a[C[4]] == s
        and a[A[2]] + a[C[0]] + a[C[2]] + a[C[4]] == s
        and a[B[0]] + a[A[1]] + a[C[0]] + a[C[3]] == s
        and a[B[2]] + a[C[1]] + a[C[2]] + a[C[3]] == s
    )
